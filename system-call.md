...
  在编译的过程中，需要根据 `syscall_32.tbl` 和 `syscall_64.tbl` 生成自己的`syscalls_32.h` 和 `syscalls_64.h`。生成方式在 `arch/x86/entry/syscalls/Makefile` 中。这里面会使用两个脚本
